...
const htmlTaskContent = ({ id, title, description, type, url }) => `
  ...
  <div class='col-md-6 col-lg-4 mt-3' id=${id} key=${id}>
    <div class='card shadow-sm task__card' style='background: gray;
    '>
      ...
      <div class='card-body'>
        ...
        <p class='description trim-3-lines' data-gram_editor='false'>
          ${description}
        </p>
...
// To get data cards on homepage from local storage (Browsers storage)
...
const handleSubmit = (event) => {
  ...
  // Updating the same on localStorage too
  updateLocalStorage();
};

// New modal on click of opentask
const openTask = (e) => {
  // pop up the current one
  if (!e) e = window.event;

  // Finding the correct card opened
